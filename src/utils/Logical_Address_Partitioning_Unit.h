...
namespace Utils
{
	...
	private:
		...
		static std::vector<std::vector<flash_channel_ID_type>> stream_channel_ids;//二维数组，表示每个io流使用的通道号
		static std::vector<std::vector<flash_chip_ID_type>> stream_chip_ids;//二维数组，表示每个io流使用的芯片号
