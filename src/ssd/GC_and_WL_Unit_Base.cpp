...
namespace SSD_Components
{
	...
	{
		_my_instance = this;
		block_pool_gc_threshold = (unsigned int)(gc_threshold * (double)block_no_per_plane);//0.05*每个分组的块数，空闲物理块低于这个阈值时会执行垃圾回收
